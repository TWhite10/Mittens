...
exports.getEnergyLevel = getEnergyLevel;
exports.getRandomCatImg = getRandomCatImg;
...
var breedDiscovery = document.getElementById("breedDiscovery");
var infoDump = document.getElementById("infoDump");

//press butten to get a random cat suggession
function getRandomCatImg() {
  return _getRandomCatImg.apply(this, arguments);
} //first select all breeds
//filter breeds into three parts
//fetch data
function _getRandomCatImg() {
  _getRandomCatImg = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var img, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          return _context.abrupt("return", response.data[0].url);
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](0);
          console.error("Error getting image :", _context.t0);
          throw _context.t0;
        case 13:
        case "end":
...
var breedsData = null;
function catFinder() {
  return _catFinder.apply(this, arguments);
} //update the dropdown when an energy level is selected
function _catFinder() {
  _catFinder = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, _breedDiscovery;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          _breedDiscovery = document.getElementById("breedDiscovery");
          _breedDiscovery.addEventListener("change", breedSelectionDropdown);
...
function breedSelectionDropdown(event) {
  ...
  var infoDump = document.getElementById("infoDump");
  infoDump.innerHTML = "";
  var selectedBreed = breedsData.find(function (breed) {
    return breed.id === selectedBreedId;
  });
  if (selectedBreed) {
    infoDump.innerHTML = "\n                    <h3>".concat(selectedBreed.name, "</h3>\n                    <p>").concat(selectedBreed.description, "</p>\n                    <p><strong>Energy Level:</strong> ").concat(selectedBreed.energy_level, "</p>\n                    <p><strong>Temperament:</strong> ").concat(selectedBreed.temperament, "</p>\n                    <p><strong>Origin:</strong> ").concat(selectedBreed.origin, "</p>\n                    <p><strong>Weight:</strong> ").concat(selectedBreed.weight, " kg</p>\n                    <p><strong>Life Span:</strong> ").concat(selectedBreed.life_span, " years</p>\n                ");
  }
  var catEnergyImg = document.getElementById("catEnergyImg");
  fetch("https://api.thecatapi.com/v1/images/search?breed_ids=".concat(selectedBreedId));
}
function getEnergyLevel() {
  return _getEnergyLevel.apply(this, arguments);
}
function _getEnergyLevel() {
  _getEnergyLevel = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var selectedRadio, selectedValue, response, catMatches, output, _infoDump;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          selectedRadio = document.querySelector('input[name="energyL"]:checked');
          if (selectedRadio) {
            _context3.next = 5;
            break;
          }
        ...
        case 5:
          selectedValue = selectedRadio.value.toLowerCase();
          if (breedsData) {
            _context3.next = 11;
            break;
          }
        ...
        case 9:
          ...
          breedsData = response.data;
        case 11:
          catMatches = breedsData.filter(function (breed) {
            //filter data by energy level 
            var energyLevel = breed.energy_level;
        ...
        case 19:
          ...
          output.innerHTML = "You have: ".concat(catMatches.length, " Matches");
          _infoDump.innerHTML = "\n            <h3>Matching Breeds:</h3>\n            ".concat(catMatches.map(function (breed) {
            return "\n                <div style=\"margin-bottom: 20px; padding: 10px; border: 1px solid #ddd; border-radius: 5px;\">\n                    <h4>".concat(breed.name, "</h4>\n                    <p><strong>Energy Level:</strong> ").concat(breed.energy_level, "/5</p>\n                    <p>").concat(breed.description, "</p>\n                </div>\n            ");
          }).join(''), "\n        ");
          _context3.next = 28;
          break;
        case 24:
...
},{"axios":"node_modules/axios/index.js","dns":"node_modules/parcel-bundler/src/builtins/_empty.js"}],"eventsHandling.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.randomImgClick = randomImgClick;
...
function randomImgClick() {
  return _randomImgClick.apply(this, arguments);
}
function _randomImgClick() {
  _randomImgClick = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var imgEl, newRandomImg;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          imgEl = document.querySelector("#catImg");
          _context.next = 3;
          return (0, _script.getRandomCatImg)();
        case 3:
          newRandomImg = _context.sent;
...
// }
},{"./script":"script.js"}],"index.js":[function(require,module,exports) {
"use strict";

var eventHandling = _interopRequireWildcard(require("./eventsHandling"));
...
document.addEventListener("DOMContentLoaded", function () {
  var randomImgButton = document.querySelector("#randomCatBtn");
  var imgEl = document.querySelector("#catImg");
...
},{"./eventsHandling":"eventsHandling.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/catSBA.e31bb0bc.js.map